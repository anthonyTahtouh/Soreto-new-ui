        ...
        <div className="grid align-items-center">
            <div className="col-12">
                <div className="card p-fluid">
                    ...
                    <div className="col">
                        <span className="p-float-label">
                            <MultiSelect id="sectorMultiSelect" value={selectedSector} onChange={(e) => setSelectedSector(e.value)} options={sectors} optionLabel="label"
                                className="w-full" />
                            <label htmlFor="sectorMultiSelect">Sector</label>
                        </span>                        
                    </div>
                    <div className="col">
                        <span className="p-float-label">
                            <MultiSelect id="networkMultiSelect" value={selectedNetwork} onChange={(e) => setSelectedNetwork(e.value)} options={networks} optionLabel="label"
                                className="w-full" />
                             <label htmlFor="networkMultiSelect">Network</label>
                        </span> 
                    </div>
                    <div className="col">
                        <span className="p-float-label">
                            <MultiSelect id="clientTypeMultiSelect" value={selectedClientType} onChange={(e) => setSelectedClientType(e.value)} options={clientTypes} optionLabel="label"
                                className="w-full" />
                                <label htmlFor="clientTypeMultiSelect">Client Type</label>
                        </span> 
                    </div>
                    <div className="col">
                        <span className="p-float-label">
                            <MultiSelect id="salesRepMultiSelect" value={selectedSalesRep} onChange={(e) => setSelectedSalesRep(e.value)} options={salesReps} optionLabel="label"
                                className="w-full" />
                            <label htmlFor="salesRepMultiSelect">Sales Rep</label>
                        </span> 
                    </div>
                    <div className="col">
                        <span className="p-float-label">
                            <MultiSelect id="fixedFeeMultiSelect" value={selectedFixedFee} onChange={(e) => setSelectedFixedFee(e.value)} options={fixedFees} optionLabel="label"
                                className="w-full" />
                            <label htmlFor="fixedFeeMultiSelect">Fixed Fee</label>
                        </span> 
                    </div>
                    ...
                    <br />
                    <div className="grid">
                        <div className="col-offset-0 col md:col-offset-8 lg:col-offset-10">
